...
TEST_IMAGE_PATHS=[]
import glob
for path1 in glob.glob(PATH_TO_TEST_IMAGES_DIR):
  TEST_IMAGE_PATHS.append(path1)
...
PATH_TO_SAVED_MODEL = "D:/TensorFlow/workspace/training_demo/exported-models/my_model3/saved_model/" 
...
for image_path in TEST_IMAGE_PATHS:
    ...
    print("image shape :{},input tensor shape :{}".format(image_np.shape,input_tensor.shape))
    ...
    cv.imshow("modified image",image_np_with_detections)
    cv.waitKey(0)
